...
# make www-data the owner of the subfolder:
    sudo chown www-data /path/to/satellite-tracker-pi/SatTrackerPiWebServer

# to configure nginx for website copy file: 
   cp /path/to/satellite-tracker-pi/SatTrackerPiWebServer/SatTrackerWeb_proxy /etc/nginx/sites-available/
...
# create database:
cd /path/to/satellite-tracker-pi/SatTrackerPiWebServer/
...
#
#    cd /path/to/satellite-tracker-pi/
...
#As root, Create Symbolic Link to  the following files into /etc/systemd/system:
    sudo ln -s /path/to/satellite-tracker-pi/SatTrackerPiDaemon/sat_tracker_pi_daemon.service /etc/systemd/system
    sudo ln -s /path/to/satellite-tracker-pi/SatTrackerPiWebServer/sat_tracker_pi_web_server.service /etc/systemd/system 
    sudo ln -s /path/to/satellite-tracker-pi/SatTrackerPiWebClient/sat_tracker_pi_web_client.service /etc/systemd/system 
